...
Feature: User Creates an account
 ...
 Scenario Outline: User can create an account
    ...
    |pruebaQE11@example.com|Mrs.  |Maria Alejandra|Sierra Carmona|Mal1234 |2-February-1991|yes       |yes     |RealPage|Calle 66 sur #43c45|Ninguna  |Sabaneta|Alaska|99501     |United States|Ninguna         |2806754  |3006312895 |parque los 4 elementos|
